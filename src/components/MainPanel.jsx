        ...
        return (
            <div className="main-panel p-6 bg-premium-gradient bg-cover bg-center animate-gradient-move shadow-premium-md">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button onClick={onLogout} className="bg-button-logout hover:bg-button-logout-hover text-light-primary font-semibold py-2 px-4 rounded-lg shadow-button-premium hover:shadow-button-premium-hover transition-shadow duration-200 font-body border border-accent-premium flex items-center">
